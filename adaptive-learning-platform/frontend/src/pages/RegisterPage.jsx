    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 420 }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ color: 'rgba(255,255,255,.8)' }}>Crie sua conta</p>
        </div>

        <div className="card">
          <div className="card-body">
            <h2 style={{ fontWeight: 700, marginBottom: 24 }}>Cadastro</h2>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                <input
                  className="form-control" type="email" placeholder="seu@email.com"
