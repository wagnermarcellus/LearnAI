  ...
  return (
    <div>
      ...
      <div className="page-header">
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
          <div>
            ...
            <p className="page-subtitle">Continue sua jornada de aprendizagem</p>
          </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: 14, marginBottom: 32 }}>
        {[
          { to: '/learning-paths', icon: '📚', label: 'Ver Trilhas',    color: '#6366f1' },
          { to: '/tutor',          icon: '🤖', label: 'Tutor IA',       color: '#8b5cf6' },
          { to: '/study-plan',     icon: '📋', label: 'Meu Plano',      color: '#10b981' },
          { to: '/progress',       icon: '📈', label: 'Meu Progresso',  color: '#f59e0b' },
        ].map(item => (
