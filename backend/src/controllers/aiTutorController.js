...
exports.chat = async (req, res, next) => {
  try {
    ...
    // Nível atual do aluno (último teste)
    ...
    // Histórico de chat para contexto (últimas 10 mensagens)
    const params = [userId];
    ...
    const chatHistory = historyResult.rows.reverse(); // cronológico
    ...
    const aiResponse = await aiService.explainConcept({
      concept: message,
      studentLevel,
      context,
      chatHistory,
